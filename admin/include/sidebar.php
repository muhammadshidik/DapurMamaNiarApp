 ...
 <aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
   ...
   <nav class="vertnav navbar navbar-light">
     ...
     <div style="height: 1px; background-color: #999; width: 100%; margin: 20px 0;"></div>
       ...
       <?php if ($dataNavbar['id_level'] == 1) : ?>
         <li class="nav-item dropdown">
           ...
           <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
             <li class="nav-item active" <?= !isset($_GET['page']) || ($_GET['page'] == 'dashboard') ? 'class="active"' : '' ?>>
               <a class="nav-link pl-3" href="?page=dashboard"><span class="ml-1 item-text">Default</span></a>
             </li>
             <li class="nav-item" <?= !isset($_GET['page']) || ($_GET['page'] == 'homepage') ? 'class="active"' : '' ?>>
               <a class="nav-link pl-3" href="?page=homepage"><span class="ml-1 item-text">Home Page</span></a>
             </li>
     ...
     <ul class="navbar-nav flex-fill w-100 mb-2">
       <li class="nav-item dropdown">
         <a href="#ui-elements" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
           ...
           <span class="ml-3 item-text">Menu Admin</span>
         </a>
         <ul class="collapse list-unstyled pl-4 w-100" id="ui-elements">
           <li class="nav-item" <?= (isset($_GET['page']) && in_array($_GET['page'], ['user', 'add-user'])) ? 'class="active"' : '' ?>>
             <a class="nav-link pl-3" href="?page=user"><span class="ml-1 item-text">Penambahan Akses</span>
             </a>
           </li>
           <li class="nav-item" <?= (isset($_GET['page']) && in_array($_GET['page'], ['level', 'add-level'])) ? 'class="active"' : '' ?>>
             <a class="nav-link pl-3" href="?page=level"><span class="ml-1 item-text">Penambahan Role</span></a>
           </li>
           <li class="nav-item" <?= (isset($_GET['page']) && in_array($_GET['page'], ['menu', 'add-menu'])) ? 'class="active"' : '' ?>>
             <a class="nav-link pl-3" href="?page=menu"><span class="ml-1 item-text">menu</span></a>
           </li>
         </ul>
       </li>
