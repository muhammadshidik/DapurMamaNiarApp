<header>
      ...
      <nav class="limiter-menu-desktop container">
        ...
        <div class="wrap-icon-header flex-w flex-r-m">
          ...
          <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
            <button type="button" class="btn btn-outline-white" data-toggle="modal" data-target="#exampleModalLong" style=" border-radius: 50px !important;">
              Login
            </button>
          </div>
  ...
  <div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
      <a href="index.html"><img src="tmp/images/icons/logo-01.png" alt="IMG-LOGO"></a>
    </div>
  ...
  <div class="menu-mobile">
    ...
    <ul class="main-menu-m">
      <li>
        ...
        <ul class="sub-menu-m">
          <li><a href="admin/content/jenis.php">Homepage 1</a></li>
