  <nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
      <div class="container-fluid">
          ...
          <div class="navbar-slide bg-white ml-lg-4" id="navbarSupportedContent">
              ...
              <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                      <a class="nav-link" href="">
                          <span class="ml-lg-2">Menu Catering</span>
                          <!-- <span class="badge badge-pill badge-primary">New</span> -->
                      </a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="widgets.html">
                          <span class="ml-lg-2">Daftar Harga</span>
                          <!-- <span class="badge badge-pill badge-primary">New</span> -->
                      </a>
                  </li>
                   <li class="nav-item">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="?page=about">
                          <span class="ml-lg-2">Tentang Dapur Mama Niar</span>
                          <!-- <span class="badge badge-pill badge-primary">New</span> -->
                      </a>
                  </li>
          ...
          <ul class="navbar-nav d-flex flex-row mr-2">
              ...
              <li class="nav-item mr-2">
                  <a class="btn btn-outline-success btn-sm mt-2 mr-2" href="index.php">
                      <span>Masuk</span>
                  </a>
                  <a class="btn btn-outline-success btn-sm mt-2 mr-2" href="register.php">
                      <span>Daftar</span>
                  </a>
              </li>
