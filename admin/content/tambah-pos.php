...
if (isset($_POST['name'])) {
    ...
    if (!isset($_GET['edit'])) {
        ...
        $Update = mysqli_query($config, "UPDATE user SET name='$name', email='$email', password='$password' WHERE id='$id_user'");
...
$queryUserRoles = mysqli_query($config, "SELECT level.*, lev.name FROM user_roles
