...
$query = "SELECT * FROM paket_catering ORDER BY id DESC";
...
<div class="container mt-4">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            ?>
            <a href="?page=add-jenisPaket" class="btn btn-primary mb-3">+ Tambah Paket</a>
                        ...
                        while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <img src="<?= $imagePath ?>" width="80" alt="<?= htmlspecialchars($row['gambar']) ?>">
                                </td>
                                <td>
                                    <a href="?page=add-jenisPaket&edit=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                                    <a href="?page=add-jenisPaket&delete=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus menu ini?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endwhile;
                    else : ?>
